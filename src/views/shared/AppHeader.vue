<template>
  <div class="container">
    <br />
    <p class="lead">alaa pproject</p>
    <div class="header-bar">
      <ul v-if="!$store.state.IsUserAuthenticated" class="slider-menu">
        <router-link class="button" to="/">Home</router-link>
        <router-link class="button" to="/login">login</router-link>
      </ul>
      <ul v-else class="slider-menu">
        <router-link class="button" to="/">Home</router-link>
        <router-link class="button" to="/profile">profile</router-link>
        <a class="button" @click="logoutUser()" href="/">logout</a>
      </ul>
    </div>
  </div>
</template>
